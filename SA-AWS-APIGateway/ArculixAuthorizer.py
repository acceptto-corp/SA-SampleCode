...
Oauth2_domain_name = 'SET_YOUR_DOMAIN_NAME_HERE’ 
...
def lambda_handler(event, context):
    ...
    payload={}
    headers = {
      'Authorization': f"Bearer {event['authorizationToken']}"
    }
    
    response = requests.request("GET", Oauth2_domain_name, headers=headers, data=payload)
